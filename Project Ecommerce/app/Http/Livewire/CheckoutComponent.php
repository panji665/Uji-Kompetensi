...
class CheckoutComponent extends Component
{
    ...
    public function placeOrder(){
        ...
        $order->shipping_charge = $this->ShoppingCharge()*5/100;
        ...
        if ($this->paymentmode == 'cod') {
            ...
            try{
                ...
                if (!isset($token['id'])) {
                    session()->flash('stripe_error','error stripe token');
                    $this->thankyou = 0;
                }
    ...
    {
        $shopping_charge = $this->ShoppingCharge()*5/100;
        $totalcharge = $this -> TotalCharge()+$shopping_charge;
