        ...
        <div class=" main-content-area">
                ...
                <div class="col-md-12">
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                <label for="city">Province<span>*</span></label>
                                <input type="text" name="city" value="" placeholder="Province" wire:model="s_province">
                                @error('s_province')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </p>
            ...
            <div class="summary summary-checkout">
                <div class="summary-item payment-method">
                    ...
                    <div class="wrap-address-billing">
                        ...
                        <p class="row-in-form">
                            ...
                            <input type="text" name="card-no" value="" placeholder="Your cart number" wire:model="card_no">
                            @error('card_no')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </p>
                ...
                <div class="summary-item shipping-method">
                    ...
                    <p class="summary-info"><span class="title">Fixed ${{$shopping_charge}}</span></p>
