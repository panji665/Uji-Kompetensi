                        ...
                        <div class="wrap-login-item ">
                            <div class="register-form form-item ">
                                ...
                                <form class="form-stl" action="{{ route('register') }}" name="frm-login" method="post" >
                                    ...
                                    <fieldset class="wrap-input">
                                        <label for="frm-reg-email">Email Address*</label>
                                        <input type="email" id="frm-reg-phone" name="phone" placeholder="Phone Number" :value="email">
                                    </fieldset>

                                    <fieldset class="wrap-title">
                                        <h3 class="form-title">Login Information</h3>
                                    </fieldset>
                                    <fieldset class="wrap-input  left-item ">
                                    ...
                                    <fieldset class="wrap-input   ">
                                        ...
                                        <a class="wrap-title left-item" href="{{ route('login') }}">Have Account</a>
                                    </fieldset>
...
<script>
    $('#frm-reg-lname').keypress(function(e) { 
